...
const getAllProducts = async (data) => {
  ...
  if(data.stores.includes("stussy")) products.push(await getStussyProducts(data.keywords))
  if(data.stores.includes("levis")) products.push(await getLeviProducts(data.keywords))
  if(data.stores.includes("paulsmith")) products.push(await getPaulSmithProducts(data.keywords))
  ...
  if(data.stores.includes("chanel")) products.push(await getChanelProducts(data.keywords))
  if(data.stores.includes("fendi")) products.push(await getFendiProducts(data.keywords))
  if(data.stores.includes("prada")) products.push(await getPradaProducts(data.keywords))
